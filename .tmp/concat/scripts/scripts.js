 ...
 */
angular.module('webUiApp').controller('MainCtrl', [
  '$scope',
  '$resource',
  'Guideline',
  'toastr',
  '$location',
  'Crud',
  function ($scope, $resource, Guideline, toastr, $location, Crud) {
    ...
    $scope.deleteGuidelineBtnClick = function (index) {
      ...
      Guideline.delete({ _id: guidelineToDelete.guidelineId }).$promise.then(function () {
...
angular.module('webUiApp').controller('GuidelineCtrl', [
  ...
  '$rootScope',
  'Crud',
  function ($scope, Guideline, Section, Author, $stateParams, $location, toastr, ModalService, $rootScope, Crud) {
    ...
    $scope.updateOrCreateGuideline = function () {
      if ($scope.guideline.guidelineId == null) {
        ...
        Guideline.update({ _id: $scope.guideline.guidelineId }, $scope.guideline).$promise.then(function () {
    ...
    $scope.deleteSectionBtnClick = function (index) {
      ...
      Section.delete({ _id: sectionToDelete.sectionId }).$promise.then(function () {
    ...
    $scope.addAuthorBtnClick = function () {
      ModalService.showModal({
        ...
        controller: [
          ...
          '$scope',
          'Author',
          function (ModalService, $scope, Author) {
    ...
    function addAuthorToGuideline(author) {
      Guideline.addAuthor({
        id: $scope.guideline.guidelineId,
    ...
    $scope.editSortOrderBtnClick = function () {
      ModalService.showModal({
            ...
            $scope.save = function () {
              ...
              for (var i = 0; i < $scope.resource.length; i++) {
                if ($scope.resource[i].sortOrder != i) {
                  ...
                  Section.update({ _id: $scope.resource[i].sectionId }, $scope.resource[i]).$promise.then(function () {
                  });
                }
              }
            };
        ...
        inputs: { sections: $scope.guideline.sections }
      }).then(function (modal) {
        modal.element.modal();
      });
    };
...
angular.module('webUiApp').factory('Guideline', [
  ...
  '$resource',
  function ($resource) {
    return $resource(apiUrl + 'authors/:_id', {}, { update: { method: 'PUT' } });
  }
]).factory('Pico', [
  '$resource',
  function ($resource) {
...
]).factory('TaxonomyCode', [
  '$resource',
  function ($resource) {
    return $resource(apiUrl + 'taxonomycodes/:_id', {}, { update: { method: 'PUT' } });
  }
]).factory('EmrInfo', [
  '$resource',
  function ($resource) {
    return $resource(apiUrl + 'emrinfos/:_id', {}, { update: { method: 'PUT' } });
  }
]).factory('KeyInfo', [
  '$resource',
  function ($resource) {
    return $resource(apiUrl + 'keyinfos/:_id', {}, { update: { method: 'PUT' } });
  }
]).factory('PicoOutcome', [
  '$resource',
  function ($resource) {
    return $resource(apiUrl + 'picooutcomes/:_id', {}, { update: { method: 'PUT' } });
  }
]).factory('Reference', [
  '$resource',
  function ($resource) {
    return $resource(apiUrl + 'referances/:_id', {}, { update: { method: 'PUT' } });
  }
]);
;
'use strict';
...
angular.module('webUiApp').controller('AuthorCtrl', [
  ...
  function ($scope, Guideline, Author, $stateParams, $location, toastr, ModalService, Crud) {
    ...
    $scope.updateOrCreateAuthor = function () {
      if (authorId > 0) {
        Author.update({ _id: authorId }, $scope.author).$promise.then(function (data) {
        ...
        ModalService.showModal({
          ...
          controller: [
            ...
            function ($scope, author, Author, close) {
              ...
              //update author
              $scope.save = function () {
                Author.update({ _id: author.authorId }, $scope.author).$promise.then(function (data) {
                  toastr.success(data.name, 'Lagret forfatter');
    ...
    $scope.deleteAuthorBtnClick = function (index) {
      ...
      Author.delete({ _id: authorToDelete.authorId }).$promise.then(function () {
...
angular.module('webUiApp').controller('SectionCtrl', [
  ...
  '$rootScope',
  'Crud',
  function ($scope, Section, Guideline, Recommendation, $stateParams, $location, toastr, ModalService, $rootScope, Crud) {
    ...
    var createSection = function (resource, id) {
      resource.addSection({ id: id }, $scope.section).$promise.then(function (data) {
    ...
    var updateSection = function (resource, id) {
      resource.update({ _id: id }, $scope.section).$promise.then(function (data) {
    ...
    $scope.deleteRecommendationBtnClick = function (index) {
      ...
      Recommendation.delete({ _id: recommendationToDelete.recommendationId }).$promise.then(function () {
            ...
            $scope.save = function () {
              ...
              for (var i = 0; i < $scope.resource.length; i++) {
                if ($scope.resource[i].sortOrder != i) {
                  ...
                  console.log($scope.resource[i].heading + ' changed sortorder from: ' + $scope.resource[i].sortOrder + ' to: ' + i);
                  $scope.resource[i].sortOrder = i;
                  Recommendation.update({ _id: $scope.resource[i].recommendationId }, $scope.resource[i]).$promise.then(function () {
                  });
                }
              }
            };
...
angular.module('webUiApp').controller('EmrInfoCtrl', [
  ...
  function ($scope, EmrInfo, $stateParams, Recommendation, $location, $timeout, toastr, Crud) {
    ...
    $scope.updateOrCreateEmrInfo = function () {
      if (emrInfoId != 0) {
        EmrInfo.update({ _id: emrInfoId }, $scope.emrInfo).$promise.then(function (data) {
        ...
        Recommendation.addEmrInfo({ id: recommendationId }, $scope.emrInfo).$promise.then(function (data) {
...
angular.module('webUiApp').controller('KeyInfoCtrl', [
  ...
  'toastr',
  'Crud',
  function ($scope, KeyInfo, $stateParams, Recommendation, $location, $timeout, toastr, Crud) {
    var guidelineId = $stateParams.guidelineId;
    var sectionId = $stateParams.sectionId;
    var recommendationId = $stateParams.recommendationId;
    ...
    $scope.updateOrCreateKeyInfo = function () {
      if (keyInfoId != 0) {
        KeyInfo.update({ _id: keyInfoId }, $scope.keyInfo).$promise.then(function (data) {
          toastr.success(data.summary, 'Lagret');
        ...
        Recommendation.addKeyInfo({ id: recommendationId }, $scope.keyInfo).$promise.then(function (data) {
...
angular.module('webUiApp').controller('RecommendationCtrl', [
  ...
  function ($scope, Recommendation, Pico, EmrInfo, Reference, KeyInfo, $stateParams, $location, Section, toastr, ModalService, $rootScope, Crud) {
    ...
    $scope.updateOrCreateRecommendation = function () {
      if (recommendationId != 0) {
        Recommendation.update({ _id: recommendationId }, $scope.recommendation).$promise.then(function (data) {
        ...
        Section.addRecommendation({ id: sectionId }, $scope.recommendation).$promise.then(function (data) {
          $rootScope.recommendationLabel = ' - ' + data.heading;
          //update breadcrumb
    ...
    $scope.deletePicoBtnClick = function (index) {
      ...
      Pico.delete({ _id: picoToDelete.picoId }).$promise.then(function () {
    ...
    $scope.deleteEmrInfoBtnClick = function (index) {
      ...
      EmrInfo.delete({ _id: emrInfoToDelete.emrInfoId }).$promise.then(function () {
    ...
    $scope.deleteKeyInfoBtnClick = function (index) {
      ...
      KeyInfo.delete({ _id: keyInfoToDelete.keyInfoId }).$promise.then(function () {
    ...
    function addReferenceToRecommendation(reference) {
      Recommendation.addReference({
        id: $scope.recommendation.recommendationId,
    ...
    function removeReferenceFromRecommendation(reference) {
      Recommendation.deleteReference({
        id: $scope.recommendation.recommendationId,
        referenceId: reference.referenceId
      }).$promise.then(function () {
...
angular.module('webUiApp').controller('ReferenceCtrl', [
  ...
  function ($scope, Reference, $stateParams, Recommendation, $location, $timeout, toastr, ModalService, Crud) {
    ...
    $scope.updateOrCreateReference = function () {
      if (referenceId != 0) {
        Reference.update({ _id: referenceId }, $scope.reference).$promise.then(function (data) {
          toastr.success(data.summary, 'Lagret');
        ...
        Recommendation.addReference({ id: recommendationId }, $scope.reference).$promise.then(function (data) {
      ...
      Reference.get({ _id: referenceId }).$promise.then(function (reference) {
        ModalService.showModal({
          ...
          controller: [
            ...
            'reference',
            'close',
            function ($scope, Reference, reference, close) {
              //set this scope's reference to the injected reference
              $scope.reference = reference;
              //update reference
              $scope.save = function () {
                Reference.update({ _id: reference.referenceId }, $scope.reference).$promise.then(function (data) {
    ...
    $scope.createReferenceBtnClick = function () {
      ModalService.showModal({
        ...
        controller: [
          ...
          'Reference',
          'close',
          function ($scope, Reference, close) {
            $scope.reference = new Reference();
            $scope.save = function () {
              $scope.reference.$save().then(function (data) {
    ...
    $scope.deleteReferenceBtnClick = function (index) {
      ...
      Reference.delete({ _id: referenceToDelete.referenceId }).$promise.then(function () {
...
angular.module('webUiApp').controller('PicoCtrl', [
  ...
  'toastr',
  'Crud',
  function ($scope, Pico, PicoCode, PicoOutcome, $stateParams, Recommendation, $location, $timeout, toastr, Crud) {
    var guidelineId = $stateParams.guidelineId;
    var sectionId = $stateParams.sectionId;
    var recommendationId = $stateParams.recommendationId;
    ...
    $scope.updateOrCreatePico = function () {
      if (picoId != 0) {
        Pico.update({ _id: picoId }, $scope.pico).$promise.then(function (data) {
          toastr.success(data.summary, 'Lagret');
        ...
        Recommendation.addPico({ id: recommendationId }, $scope.pico).$promise.then(function (data) {
    ...
    $scope.deletePicoOutcomeBtnClick = function (index) {
      ...
      PicoOutcome.delete({ _id: picoOutcomeToDelete.picoOutcomeId }).$promise.then(function () {
...
angular.module('webUiApp').controller('PicoOutcomeCtrl', [
  ...
  function ($scope, PicoOutcome, $stateParams, Pico, $location, $timeout, toastr, Crud) {
    ...
    $scope.updateOrCreatePicoOutcome = function () {
      if (picoOutcomeId != 0) {
        PicoOutcome.update({ _id: picoOutcomeId }, $scope.picoOutcome).$promise.then(function (data) {
          toastr.success(data.summary, 'Lagret');
        ...
        Pico.addPicoOutcome({ id: picoId }, $scope.picoOutcome).$promise.then(function (data) {
 ...
 * # deleteAuthorBtn
 */
angular.module('webUiApp').directive('deleteAuthorBtn', function () {
  return {
    template: '<div></div>',
    restrict: 'E',
    link: function postLink(scope, element, attrs) {
 ...
 * # onHearing
 */
angular.module('webUiApp').directive('onHearing', [
  '$state',
  '$stateParams',
  function ($state, $stateParams) {
    return {
      template: '<div class="row" ng-if="publishedStage == 1">' + '<div class="col-md-12"><div class="alert alert-info">' + 'H\xf8ringsadresse: <a href="{{url}}">{{url}}</a>' + '</div></div>' + '</div>',
      restrict: 'EA',
      scope: { 'publishedStage': '=publishedstage' },
      link: function (scope, element, attrs) {
        var baseUrl = 'http://localhost:8000/#/';
        switch ($state.current.name) {
        case 'guideline':
...
angular.module('webUiApp').service('Crud', [
  ...
  'toastr',
  '$location',
  function crud(EmrInfo, KeyInfo, toastr, $location) {
    this.delete = function (item, location, type, id) {
      eval(type).delete({ _id: eval(id) }).$promise.then(function () {
