...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.app %>/common/**/*.js', '<%= yeoman.app %>/components/**/*.js', '<%= yeoman.app %>/assets/libs/*.js'],
    ...
    htmlmin: {
      dist: {
        ...
        files: [{
          expand: true,
          cwd: '<%= yeoman.dist %>',
          src: ['*.html', 'components/{,*/}*.html', 'common/{,*/}*.html'],
          dest: '<%= yeoman.dist %>'
        }]
      }
    },
    ...
    replace: {
      serverUrl: {
        ...
        replacements: [{
          ...
          to: "https://data.helsedirektoratet.no/"
        },
        {
          from: "http://localhost:8000/",
          to: "https://red-data.helsedirektoratet.no/preview/"
        }]
      }
    },
